...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-09-2026 a las 14:28:25
...
INSERT INTO `productos` (`id_productos`, `nombre`, `estado_producto`, `descripcion`, `stock`, `precio`, `id_vendedor`, `id_comprador`, `id_categoria`) VALUES
(1, 'Pera', '', '', 0, 0.00, 1, NULL, 0),
(3, 'Manzana', 'Cualquiera', 'MAnzana', 1, 0.00, 1, NULL, 0);
...
ALTER TABLE `productos`
  ...
  ADD KEY `fk_catego_producto` (`id_categoria`);
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `fk_catego_producto` FOREIGN KEY (`id_categoria`) REFERENCES `categoria` (`id_categoria`), ON DELETE SET NULL ON UPDATE CASCADE,|
