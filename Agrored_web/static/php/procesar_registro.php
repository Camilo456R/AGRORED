<?php
    ...
    $puerto_db = 3308; // IMPORTANTE: debe coincidir con el puerto real de MySQL en XAMPP (revisa el panel de XAMPP -> MySQL -> Config -> my.ini, o phpMyAdmin -> Variables -> port)
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $miconexion = mysqli_connect($servidor, $usuario_db, $clave_db, $db, $puerto_db);
