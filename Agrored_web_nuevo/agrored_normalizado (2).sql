...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-09-2026 a las 23:36:34
...
--
-- Base de datos: `agrored_normalizado`
--
...
CREATE TABLE `calificacion` (
  `id_calificacion` varchar(15) NOT NULL,
  `id_pedido` varchar(15) NOT NULL COMMENT 'Transaccion concreta que se califica',
  `id_comprador` varchar(15) NOT NULL,
...
CREATE TABLE `detalle_pedido` (
  `id_detalle_pedido` varchar(15) NOT NULL,
...
CREATE TABLE `movimiento_inventario` (
  `id_movimiento` varchar(15) NOT NULL,
  `id_productos` varchar(15) NOT NULL,
...
CREATE TABLE `soporte_tecnico` (
  `id_soporte` varchar(15) NOT NULL,
  `id_usuario` int(11) NOT NULL COMMENT 'Usuario que solicita el soporte',
  `id_administrador` varchar(15) DEFAULT NULL COMMENT 'Administrador asignado (puede quedar sin asignar)',
...
--
ALTER TABLE `productos`
  ADD CONSTRAINT `fk_productos_comprador` FOREIGN KEY (`id_comprador`) REFERENCES `comprador` (`id_comprador`) ON DELETE CASCADE ON UPDATE CASCADE,
